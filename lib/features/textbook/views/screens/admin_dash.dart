  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          // Sun and Moon Icon buttons for theme toggle
          IconButton(
            icon: Icon(
              isDarkMode ? Icons.wb_sunny : Icons.nights_stay, // Toggle between sun and moon
              color: isDarkMode ? Colors.yellow : Colors.blueGrey,
            ),
            onPressed: () {
              ref.read(themeProvider.notifier).toggleTheme(!isDarkMode); // Toggle the theme
            },
          ),
        ],
      ),
